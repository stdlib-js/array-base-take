...
interface Take {
	...
	* var out = new Float16Array( [ 0.0, 0.0, 0.0, 0.0 ] );
	*
	* var arr = take.assign( x, [ 1, 3 ], 'throw', out, 2, 0 );
	* // returns <Float16Array>[ 2.0, 0.0, 4.0, 0.0 ]
	*
	* var bool = ( arr === out );
	* // returns true
	*/
	assign( x: Collection | AccessorArrayLike<any>, indices: IndexArray, mode: Mode, out: Float16Array, stride: number, offset: number ): Float16Array;
