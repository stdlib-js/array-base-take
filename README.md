...
```javascript
import take from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-take@v0.3.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-take/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/array-base-take/actions/workflows/test.yml?query=branch:v0.3.1
