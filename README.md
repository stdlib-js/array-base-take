...
```javascript
import take from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-take@v0.3.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-take@v0.3.1-esm/index.mjs';
```
