...
```javascript
take = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-take@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-take@v0.3.0-umd/browser.js"></script>
```
